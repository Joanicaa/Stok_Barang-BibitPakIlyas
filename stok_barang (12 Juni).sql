...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2023 at 09:05 AM
...
--
-- Constraints for table `datapembelian`
--
ALTER TABLE `datapembelian`
  ADD CONSTRAINT `datapembelian_ibfk_1` FOREIGN KEY (`Id_Detail`) REFERENCES `detailpembelian` (`Id_Detail`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
